-- ============================================================
-- AISA Club Website — COMPLETE SCHEMA FIX
-- Run this ONCE in Supabase SQL Editor → SQL Editor → New query
-- Safe to re-run: all statements use IF NOT EXISTS / IF EXISTS
-- ============================================================

-- ============================================================
-- SECTION 1: CREATE ALL TABLES (with full column definitions)
...
-- ============================================================
-- SECTION 2: ADD MISSING COLUMNS TO TABLES THAT ALREADY EXIST
...
-- ============================================================
-- SECTION 3: ROW LEVEL SECURITY — ENABLE + PUBLIC READ POLICIES
-- ============================================================
...
-- Public read policies (anyone can read active/public data)
DO $$ BEGIN
  -- site_settings
...
-- Admin full-access policies (authenticated users can do everything)
DO $$ BEGIN
...
-- ============================================================
-- SECTION 5: SEED INITIAL DATA (skips if data already exists)
-- ============================================================
...
INSERT INTO public.events (title, description, event_type, event_date, location, max_participants, entry_fee, is_active, is_completed) VALUES
  ('AI & ML Workshop Series',
   'A comprehensive 3-day workshop series covering Machine Learning fundamentals, Neural Networks, and real-world AI applications.',
   'workshop', NOW() + INTERVAL '30 days', 'ISBM College of Engineering, Pune', 60, 0, true, false),
  ('DataThon 2025',
   'AISA flagship data science hackathon. Prizes worth ₹50,000+ and direct internship opportunities.',
   'hackathon', NOW() + INTERVAL '45 days', 'ISBM College of Engineering, Pune', 100, 200, true, false),
  ('Industry Talk: Future of AI',
   'Exclusive guest lecture by senior professionals from leading AI companies.',
   'seminar', NOW() + INTERVAL '15 days', 'ISBM College Auditorium, Pune', 200, 0, true, false),
  ('Python & Data Science Bootcamp',
   'Intensive bootcamp covering Python programming, data analysis with Pandas, and visualization.',
   'workshop', NOW() - INTERVAL '30 days', 'ISBM College of Engineering, Pune', NULL, 0, true, true),
  ('Smart India Hackathon Preparation Camp',
   'Preparation camp for SIH with mock problem statements, team building, and mentoring.',
   'hackathon', NOW() - INTERVAL '60 days', 'ISBM College of Engineering, Pune', NULL, 0, true, true)
ON CONFLICT DO NOTHING;
...
-- ============================================================
-- DONE — All tables created, all columns added, data seeded
-- ============================================================
