-- Safe Idempotent SQL Setup for Missing Admin Tables --

-- File: 20251129101820_0405e734-11e1-4582-8c57-c6a49195b3f7.sql
-- Club website settings table
CREATE TABLE IF NOT EXISTS public.site_settings (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  club_name TEXT NOT NULL DEFAULT 'AISA',
  club_full_name TEXT NOT NULL DEFAULT 'Arttifcial Intelligance and Data Science Students Association',
  ...
  email TEXT DEFAULT 'aisaclub@isbmcoe.org',
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Public can read site settings' AND tablename = 'site_settings'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Public can read announcements' AND tablename = 'announcements'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Public can read hero slides' AND tablename = 'hero_slides'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Public can read about features' AND tablename = 'about_features'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Public can read stats' AND tablename = 'stats'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Public can read events' AND tablename = 'events'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Public can read team members' AND tablename = 'team_members'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Public can read gallery' AND tablename = 'gallery'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Public can read quick links' AND tablename = 'quick_links'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Public can read partners' AND tablename = 'partners'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage site settings' AND tablename = 'site_settings'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage announcements' AND tablename = 'announcements'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage hero slides' AND tablename = 'hero_slides'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage about features' AND tablename = 'about_features'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage stats' AND tablename = 'stats'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage events' AND tablename = 'events'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage team members' AND tablename = 'team_members'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage gallery' AND tablename = 'gallery'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage quick links' AND tablename = 'quick_links'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage partners' AND tablename = 'partners'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can view own profile' AND tablename = 'admin_profiles'
    ) THEN
...
ALTER TABLE public.events ADD COLUMN IF NOT EXISTS IF NOT EXISTS entry_fee decimal(10,2) DEFAULT 0;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Users can view own profile' AND tablename = 'user_profiles'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Users can insert own profile' AND tablename = 'user_profiles'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Users can update own profile' AND tablename = 'user_profiles'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can view all profiles' AND tablename = 'user_profiles'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage profiles' AND tablename = 'user_profiles'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Users can view own registrations' AND tablename = 'event_registrations'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Users can register for events' AND tablename = 'event_registrations'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Users can update own registration' AND tablename = 'event_registrations'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage registrations' AND tablename = 'event_registrations'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Users can view own payments' AND tablename = 'payments'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Users can create payments' AND tablename = 'payments'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage payments' AND tablename = 'payments'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Users can view own certificates' AND tablename = 'certificates'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage certificates' AND tablename = 'certificates'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Public can view winners' AND tablename = 'event_winners'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage winners' AND tablename = 'event_winners'
    ) THEN
...
DROP TRIGGER IF EXISTS generate_payment_receipt ON public.payments;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Public can read charter' AND tablename = 'charter_settings'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage charter' AND tablename = 'charter_settings'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Public can read active news' AND tablename = 'news'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage news' AND tablename = 'news'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Public can read downloads' AND tablename = 'downloads'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage downloads' AND tablename = 'downloads'
    ) THEN
...
ALTER TABLE public.hero_slides ADD COLUMN IF NOT EXISTS club_id uuid REFERENCES public.clubs(id) ON DELETE CASCADE;
ALTER TABLE public.announcements ADD COLUMN IF NOT EXISTS club_id uuid REFERENCES public.clubs(id) ON DELETE CASCADE;
ALTER TABLE public.about_features ADD COLUMN IF NOT EXISTS club_id uuid REFERENCES public.clubs(id) ON DELETE CASCADE;
ALTER TABLE public.stats ADD COLUMN IF NOT EXISTS club_id uuid REFERENCES public.clubs(id) ON DELETE CASCADE;
ALTER TABLE public.events ADD COLUMN IF NOT EXISTS club_id uuid REFERENCES public.clubs(id) ON DELETE CASCADE;
ALTER TABLE public.team_members ADD COLUMN IF NOT EXISTS club_id uuid REFERENCES public.clubs(id) ON DELETE CASCADE;
ALTER TABLE public.gallery ADD COLUMN IF NOT EXISTS club_id uuid REFERENCES public.clubs(id) ON DELETE CASCADE;
ALTER TABLE public.partners ADD COLUMN IF NOT EXISTS club_id uuid REFERENCES public.clubs(id) ON DELETE CASCADE;
ALTER TABLE public.downloads ADD COLUMN IF NOT EXISTS club_id uuid REFERENCES public.clubs(id) ON DELETE CASCADE;
ALTER TABLE public.news ADD COLUMN IF NOT EXISTS club_id uuid REFERENCES public.clubs(id) ON DELETE CASCADE;
ALTER TABLE public.popup_announcements ADD COLUMN IF NOT EXISTS club_id uuid REFERENCES public.clubs(id) ON DELETE CASCADE;
ALTER TABLE public.quick_links ADD COLUMN IF NOT EXISTS club_id uuid REFERENCES public.clubs(id) ON DELETE CASCADE;
ALTER TABLE public.charter_settings ADD COLUMN IF NOT EXISTS club_id uuid REFERENCES public.clubs(id) ON DELETE CASCADE;
ALTER TABLE public.alumni ADD COLUMN IF NOT EXISTS club_id uuid REFERENCES public.clubs(id) ON DELETE CASCADE;
ALTER TABLE public.user_profiles ADD COLUMN IF NOT EXISTS club_id uuid REFERENCES public.clubs(id) ON DELETE SET NULL;
...
ALTER TABLE public.clubs ADD COLUMN IF NOT EXISTS IF NOT EXISTS is_suspended boolean DEFAULT false;
ALTER TABLE public.clubs ADD COLUMN IF NOT EXISTS IF NOT EXISTS suspension_reason text;
...
BEGIN
  IF NOT EXISTS (
    ...
    ALTER TABLE public.certificates ADD COLUMN IF NOT EXISTS rank text;
  END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage alumni' AND tablename = 'alumni'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage occasions' AND tablename = 'occasions'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage popups' AND tablename = 'popup_announcements'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can manage templates' AND tablename = 'certificate_templates'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can update all profiles' AND tablename = 'user_profiles'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Admins can delete profiles' AND tablename = 'user_profiles'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policename = 'Public can read visitor count' AND tablename = 'visitor_counter'
    ) THEN
