...
const SQL_SETUP = `-- Run this ONCE in the Supabase SQL Editor (re-run if you ran the old version)
CREATE OR REPLACE FUNCTION public.assign_admin_role(
  p_user_id uuid, p_role text, p_full_name text,
  p_email text, p_club_id uuid DEFAULT NULL
)
RETURNS jsonb LANGUAGE plpgsql SECURITY DEFINER SET search_path = public AS $$
DECLARE v_db_role app_role; v_profile_role text; BEGIN
  ...
  IF p_club_id IS NOT NULL THEN
    INSERT INTO public.club_admins (club_id, user_id, role, is_primary)
      VALUES (p_club_id, p_user_id, p_role, false) ON CONFLICT (club_id, user_id) DO NOTHING;
  END IF;
